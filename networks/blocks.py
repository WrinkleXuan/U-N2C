...
class ConvolutionBlockForPatch(nn.Module):
    def __init__(self, conv='conv2d', norm='instance', activ='relu', pad='reflect', padding=0, **conv_opts):
        super(ConvolutionBlockForPatch, self).__init__()
    ...
    def forward(self, x):
        ...
        return self.activ(self.norm(self.conv(self.pad(x)))).flatten(2).transpose(1,2).contiguous()
